...
Based on the information provided by the business user, you have identified that the business process in question is the **_Sales process_**. In the next part, you are going to design a dimensional model for the Sales process.
